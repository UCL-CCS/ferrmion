...
def test_double_fermionic_operator(four_mode_tt):
    jw_expected = [('', np.array([], dtype=np.int64), 0.25), ('Z', np.array([3]), -0.25), ('Z', np.array([3]), -0.25), ('', np.array([], dtype=np.int64), 0.25)]
    ...
    bk_expected = [('', np.array([], dtype=np.int64), 0.25), ('ZZZ', np.array([0,2,3]), -0.25), ('ZZZ', np.array([0,2,3]), -0.25), ('', np.array([], dtype=np.int64), 0.25)]
