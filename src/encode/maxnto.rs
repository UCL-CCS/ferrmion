...
pub fn maxnto_symplectic_matrix(n_modes: usize) -> Result<(Array1<u8>, Array2<bool>), MaxNTOError> {
    let k = n_modes - 1;
...
mod tests {
    ...
    fn test_maxnto_symplectic_matrix_n14() {
        ...
        let expected_y_count: Vec<u8> = vec![
            0, 1, 0, 1, 2, 3, 2, 3, 0, 1, 0, 1, 2, 3, 2, 3, 0, 1, 0, 1, 2, 3, 2, 3, 0, 1, 0, 1,
        ];
